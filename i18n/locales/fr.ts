...
export default {
  "nav": {
    ...
    "history": "Journal de Connexion",
    "contacts": "Cercle de Connexion",
  ...
  "contacts": {
    ...
    "canSeeNotes": "Peut voir les notes privées",
  ...
  "wizard": {
    ...
    "shareSave": {
      ...
      "addMoreContacts": "Ajouter plus de contacts",
      "sendToContacts": "Envoyer à {{count}} contact(s)",
      "saveForMyself": "Enregistrer pour moi-même"
    },
    "buttons": {
      "next": "Étape suivante",
      "back": "Retour"
  ...
  "profileSetup": {
    "title": "Qui êtes-vous ?",
    "subtitle": "Configurons votre profil pour que vos amis sachent qui partage son flow.",
    "nameLabel": "Votre Nom",

...
export default {
  ...
  "settings": {
    ...
    "darkModeDesc": "Alterne entre os temas claro e escuro",
    ...
    "crashReporting": "Relatórios de Falhas",
  ...
  "dataExport": {
    ...
    "entriesFound": "{{count}} registros encontrados",
    "noEntries": "Nenhum registro no período selecionado.",
  ...
  "crisisModal": {
    ...
    "description1": "Nosso monitor de bem-estar de IA detectou um padrão preocupante em seus registros recentes (por exemplo, carga mental alta sustentada e baixa energia).",
    "description2": "Você gostaria de notificar seus 3 principais contatos de suporte?",
  ...
  "onboarding": {
    ...
    "subtitle": "O primeiro passo para traduzir seu estado mental para uma linguagem universal.",
    "bucketTitle": "O Balde",

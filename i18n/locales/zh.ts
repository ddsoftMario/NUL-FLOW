...
export default {
  ...
  "share": {
    "text": "快来看看 NUL flow，一款很棒的应用，可以用来追踪你的健康状况：{{url}}",
  ...
  "inbox": {
    ...
    "preview": {
      "title": "功能预览",
      "description": "即将在您附近的 NUL Flow 应用中推出 ;)."
    },
    "welcomeMessage": "欢迎来到您的 NUL flow 收件箱！一旦功能上线，您将在这里看到来自您的连接圈的更新。",
    "fromNulFlowTeam": "NUL flow 团队"
  },
  "history": {
    "title": "连接日志",
  ...
  "settings": {
    ...
    "about": "关于 NUL flow",
    "aboutDesc": "由 1013th 创建，在 DDSoft VZW 的帮助下为所有神经多样性社区发布 ..",
    "profile": "个人资料",
    "screenName": "显示名称",
    "screenNameDesc": "此名称对您的联系人可见",
    "dataManagement": "数据管理",
    "resetData": "重置应用数据",
    "resetDataDesc": "永久删除您的历史记录和联系人。",
    "resetButton": "重置",
    "resetConfirmTitle": "重置应用数据？",
    "resetConfirmMessage": "这将永久删除您的整个连接日志和联系人列表。此操作无法撤销。"
  },
  "dataExport": {
    "title": "数据导出",
  ...
  "dailyCheckin": {
    "title": "每日签到",
    "message": "嘿！今天过得怎么样？花点时间记录一下你的一天。",
    "placeholder": "是什么触发了你？是什么让你感到快乐、充满活力或感到空虚？",
    "save": "保存到日志",
    "notNow": "今天不"
  },
  "languages": {
  ...
  "profileSetup": {
   ...
   "installBanner": {
    "prompt": "在您的设备上获取完整的应用体验。",
    "installButton": "安装",
    "iosPrompt": "要安装，请点击分享图标并选择“添加到主屏幕”。",
    "dismiss": "关闭"
  }
};